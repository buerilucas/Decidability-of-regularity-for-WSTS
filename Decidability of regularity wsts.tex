...
Un $d-$VAS $S=(A,\xinit)$ n'est pas structurellement rationnel si et seulement s'il existe $\vect{x}_1, \vect{x}_2, \vect{x}_3, \vect{x}_4 \in \Z^d$ tels que 
\begin{enumerate}
...
\begin{Theorem}
\xout{$S=(A,\xinit)$} $A$ n'est pas structurellement rationnel si et seulement s'il existe $u,v\in \Sigma^*$ tels que 
\begin{enumerate}
