...
l'ensemble $\overline{R(A)}=\uparrow M_A$ et $M_A$ est fini.
\end{Proposition}
...
\begin{proof}
Montrons que $\overline{R(A)}$ est clos par le haut. Soit $\vect{x},\vect{x'}\in\N^d$ deux configurations vérifiant $\vect{x} \leq \vect{x'}$.
