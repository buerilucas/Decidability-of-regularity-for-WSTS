...
On dit que $\vect{y}$ est \emph{$\omega$-accessible} à partir de $\vect{x}$ lorsque pour tout $k\in\N$, il existe un mot $u_k \in A^*$ franchissable à partir de $\vect{x}$ tel que \alain{faire le lien avec la definition d'omega transition et d'acceleration dans papier avec Igor et Serge}
\begin{enumerate}
...
\begin{Theorem}\alain{le theoreme 28 n'a rien à faire là}
\lucas{À rectifier}
