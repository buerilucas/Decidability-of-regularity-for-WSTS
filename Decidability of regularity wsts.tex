...
Commençons par énoncer une propriété de monotonie de la non-rationalité \xout{selon les configurations initiales choisies.}
...
\begin{Definition}
On dit qu'un $d-$VAS $A$ est \emph{structurellement rationnel} lorsque $\lang(A,\vect{x})$ %(ou $(A,\vect{x})$ ?) 
