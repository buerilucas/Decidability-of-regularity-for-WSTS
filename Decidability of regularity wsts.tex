...
Un autre problème a été étudié dans  \cite{vavn81}, à savoir de décider si un VASS est rationnel pour toute configuration initiale (problème de la rationalité structurelle). Il est énoncé décidable (\cite{vavn81}, Théorème 6) mais la preuve est incomplète puisque la partie non triviale est seulement évoquée informelllement. De plus, la complexité du problème de la rationalité structurelle n'a pas été étudiée.
