...
{\bf Contribution}
\begin{itemize}
\item On corrige la preuve du résultat de Yoeli et Ginzbourg  \cite{giyo80} que nous utiliserons pour prouver la décidabilité du problème de la rationalité structurelle. Nous commençons par montrer que $S$ est rationnel ssi  le quotient d'une relation d'équivalence $\equiv_2$, que nous définissons, est fini. Ce résultat ressemble au résultat principal de \cite{giyo80} mais la preuve du Théorème 2 et du Lemme 2 sont incorrectes essentiellement car la relation d'équivalence utilisée $\equiv_1$ n'a pas les propriétés nécessaires pour prouver le Théorème 2 de \cite{giyo80}. 
